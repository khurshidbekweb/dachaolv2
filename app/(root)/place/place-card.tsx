...
const PlaceCard = (place: place) => {
    return (
        <Link href={`/place/${place.id}`} className='relative max-w-[155px] h-[170px] md:max-w-[240px] lg:max-w-[280px]  transition-colors rounded-md'>
            <Image className='rounded-md min-w-[160px] md:w-[210px] !h-[170px] object-cover' sizes="(min-width: 130px)" width={130} height={150} src={`${IMG_BASE_URL}${place.image}`} alt={place.name}/>
