...
const ServiceCard = (props: services) => {
    ...
    return (
        <div className="services-card relative w-full md:max-w-[450px] h-[400px] rounded-md overflow-hidden shadow-lg border flex flex-col items-start justify-start">
            <Image
