...
const GlobalFilter = () => {
    ...
    return (
        <Drawer>
            ...
            <DrawerContent aria-describedby='' className=''>
                <DrawerHeader aria-describedby="">
                    <div className="container max-w-6xl mx-auto pt-5">
                        ...
                        <div className={cn('grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 w-full overflow-y-scroll')}>
