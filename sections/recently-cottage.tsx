    ...
    return (
        <div className="px-2 md:px-1">
            <div className="flex items-center gap-x-2 justify-between">
                ...
                <Link href={'/cottage'} className="text-[12px] cursor-pointer md:text-[16px] bg-slate-500 !text-red-600 p-[6px] border rounded-md flex items-center">Hammasi <MdOutlineKeyboardArrowRight size={20}/></Link>
            </div>
